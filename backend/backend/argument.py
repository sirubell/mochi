...
submission_post_args.add_argument("user_id", type=int, required=True)
submission_post_args.add_argument("problem_id", type=int, required=True)
submission_post_args.add_argument("source_id", type=int, required=True)
submission_post_args.add_argument("status", type=int, required=True)
submission_post_args.add_argument("error_hint", type=int)
submission_post_args.add_argument("error_line", type=int)
submission_post_args.add_argument("language", type=str, required=True)
submission_post_args.add_argument("time_used", type=str, required=True)
submission_post_args.add_argument("Memory_used", type=str, required=True)
submission_post_args.add_argument("exam_id", type=int)
submission_post_args.add_argument("homework_id", type=int)
submission_post_args.add_argument("code_content", type=str, required=True)
